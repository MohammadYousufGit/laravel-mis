...
<div class="card">
    <div class="card-body">
            <h4 class="card-title" style="font-size:25px;text-align:center">Program / Stakeholder's Profile Details Form</h4>
                            <!-- <h6 class="card-subtitle">A plugin to make masks on form fields for better instant validations.</h6> -->
                        <hr>
                        <br>
                        <form method="post" Disabled action="{{route('stakeholder.store')}}" enctype="multipart/form-data" >
                        {{csrf_field()}}
                        {{method_field('put')}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('stakeholder_name') ? 'is-invalid':''}}" Disabled value="{{$stakeholder->stakeholder_name}}" name="stakeholder_name" id="stakeholder_name" data-mask="00/00/0000" placeholder="">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>Agency</label>
                                        <input type="text" class="form-control input-mask {{$errors->has('agency') ? 'is-invalid':''}}" Disabled value="{{$stakeholder->agency}}" name="agency" id="agency" data-mask="00/00/0000" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('id_number') ? 'is-invalid':''}}" value="{{$stakeholder->id_number}}" Disabled name="id_number" id="id_number" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('personal_mobile_number') ? 'is-invalid':''}}" Disabled value="{{$stakeholder->personal_mobile_number}}" name="personal_mobile_number" id="personal_mobile_number" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('family_mobile_number') ? 'is-invalid':''}}"  Disabled value="{{$stakeholder->family_mobile_number}}" name="family_mobile_number" id="family_mobile_number" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>Age</label> 
                                        <input type="text" class="form-control input-mask {{$errors->has('age') ? 'is-invalid':''}}" Disabled value="{{$stakeholder->age}}" name="age" id="age" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
                                        @if($errors->has('age'))
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>Project</label>
                                        <input type="text" class="form-control input-mask {{$errors->has('project') ? 'is-invalid':''}}" Disabled value="{{$stakeholder->project}}"  name="project" id="project" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('role_in_the_project') ? 'is-invalid':''}}" Disabled value="{{$stakeholder->role_in_the_project}}" name="role_in_the_project" id="role_in_the_project" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control date-picker"  class="form-control input-mask {{$errors->has('data_contaced') ? 'is-invalid':''}}" Disabled value="{{$stakeholder->data_contaced}}" name="data_contaced" id="data_contaced" placeholder="Pick a date">
                                            <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('feedback') ? 'is-invalid':''}}" Disabled  value="{{$stakeholder->feedback}}" name="feedback" id="feedback" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>Remarks</label>
                                        <input type="text" class="form-control input-mask {{$errors->has('qarardad_date') ? 'is-invalid':''}}" Disabled value="{{$stakeholder->remarks}}" name="remarks" id="remarks" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
