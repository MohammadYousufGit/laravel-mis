...
<div class="card">
    <div class="card-body">
            <h4 class="card-title" style="font-size:25px;text-align:center">Program / Stakeholder's Profile New Entry Form</h4>
                            <!-- <h6 class="card-subtitle">A plugin to make masks on form fields for better instant validations.</h6> -->
                        <hr>
                        <br>
                        <form method="post"  action="{{route('stakeholder.store')}}" enctype="multipart/form-data" >
                        {{csrf_field()}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('role_in_the_project') ? 'is-invalid':''}}"  value="{{old('role_in_the_project')}}" name="role_in_the_project" id="role_in_the_project" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control date-picker"  class="form-control input-mask {{$errors->has('data_contaced') ? 'is-invalid':''}}" value="{{old('data_contaced')}}" name="data_contaced" id="data_contaced" placeholder="Pick a date">
                                            <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('feedback') ? 'is-invalid':''}}"  value="{{old('feedback')}}" name="feedback" id="feedback" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>Remarks</label>
                                        <input type="text" class="form-control input-mask {{$errors->has('qarardad_date') ? 'is-invalid':''}}" value="{{old('remarks')}}" name="remarks" id="remarks" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
