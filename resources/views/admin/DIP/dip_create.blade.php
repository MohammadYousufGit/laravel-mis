                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('monthly_report') ? 'is-invalid':''}}" value="{{old('monthly_report')}}" name="monthly_report" id="monthly_report" data-mask="00/00/0000" placeholder="">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('agency') ? 'is-invalid':''}}" value="{{old('status_achieved')}}" name="status_achieved" id="status_achieved" data-mask="00/00/0000" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('status_not_achieved') ? 'is-invalid':''}}" value="{{old('status_not_achieved')}}" name="status_not_achieved" id="status_not_achieved" data-mask="00/00/0000" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('status_reason') ? 'is-invalid':''}}" value="{{old('status_reason')}}" name="status_reason" id="status_reason" data-mask="00/00/0000" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('comments_remarks') ? 'is-invalid':''}}" value="{{old('comments_remarks')}}" name="comments_remarks" id="comments_remarks" data-mask="00/00/0000" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control date-picker"  class="form-control input-mask {{$errors->has('date') ? 'is-invalid':''}}" value="{{old('date')}}" name="date" id="date" placeholder="Pick a date">
                                            <i class="form-group__bar"></i>
                                            @if($errors->has('date'))
