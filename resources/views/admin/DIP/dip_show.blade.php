...
<div class="card">
    <div class="card-body">
            <h4 class="card-title" style="font-size:25px;text-align:center">Program / DIP New Entry Form</h4>
                        ...
                        <hr>
                        <br>
                        <form method="post"  action="{{route('DIP.store')}}" enctype="multipart/form-data" >
                        {{csrf_field()}}
                        {{method_field('put')}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('monthly_report') ? 'is-invalid':''}}" Disabled value="{{$DIP->monthly_report}}" name="monthly_report" id="monthly_report" data-mask="00/00/0000" placeholder="">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('agency') ? 'is-invalid':''}}" Disabled value="{{$DIP->status_achieved}}" name="status_achieved" id="status_achieved" data-mask="00/00/0000" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('status_not_achieved') ? 'is-invalid':''}}" Disabled value="{{old('status_not_achieved',$DIP->status_not_achieved)}}" name="status_not_achieved" id="status_not_achieved" data-mask="00/00/0000" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('status_reason') ? 'is-invalid':''}}" Disabled value="{{old('status_reason',$DIP->status_reason)}}" name="status_reason" id="status_reason" data-mask="00/00/0000" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('comments_remarks') ? 'is-invalid':''}}" Disabled value="{{old('comments_remarks',$DIP->comments_remarks)}}" name="comments_remarks" id="comments_remarks" data-mask="00/00/0000" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control date-picker"  class="form-control input-mask {{$errors->has('date') ? 'is-invalid':''}}" Disabled value="{{old('date',$DIP->date)}}" name="date" id="date" placeholder="Pick a date">
                                            <i class="form-group__bar"></i>
                                            @if($errors->has('date'))
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                     <div class="btn-demo">
                                          ...
                                          <a href="{{route('DIP.index')}}" class="btn btn-danger">Cancel</a>
                                      </div>
                                      </div>
                                </div>
