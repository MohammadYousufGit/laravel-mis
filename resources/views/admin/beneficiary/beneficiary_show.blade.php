...
<div class="card">
    <div class="card-body">
            <h4 class="card-title" style="font-size:25px;text-align:center">Program / Beneficiary's Profile Details Form</h4>
                        ...
                        @endforeach -->
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('beneficiary_name') ? 'is-invalid':''}}" Disabled value="{{old('beneficiary_name',$beneficiary->beneficiary_name)}}" name="beneficiary_name" id="beneficiary_name" data-mask="00/00/0000" placeholder="">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('father_name') ? 'is-invalid':''}}" Disabled value="{{old('father_name',$beneficiary->father_name)}}" name="father_name" id="father_name" data-mask="00/00/0000" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('id_number') ? 'is-invalid':''}}" Disabled value="{{old('id_number',$beneficiary->id_number)}}" name="id_number" id="id_number" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('personal_mobile_number') ? 'is-invalid':''}}" Disabled value="{{old('personal_mobile_number',$beneficiary->personal_mobile_number)}}" name="personal_mobile_number" id="personal_mobile_number" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('family_mobile_number') ? 'is-invalid':''}}" Disabled value="{{old('family_mobile_number',$beneficiary->family_mobile_number)}}" name="family_mobile_number" id="family_mobile_number" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>Age</label> 
                                        <input type="text" class="form-control input-mask {{$errors->has('age') ? 'is-invalid':''}}" Disabled value="{{old('age',$beneficiary->age)}}" name="age" id="age" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
                                        @if($errors->has('age'))
                                ...
                                <label>Province</label>
                                    <div class="form-group" >
                                            <div class="select">
                                                <select class="form-control" Disabled id="province" name="province" >
                                ...
                                <label>District</label>
                                    <div class="form-group" >
                                            <div class="select">
                                                <select class="form-control" Disabled name="district" id="district">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-mask {{$errors->has('head_of_the_village_council_name') ? 'is-invalid':''}}" Disabled value="{{old('head_of_the_village_council_name',$beneficiary->head_of_the_village_council_name)}}"  name="head_of_the_village_council_name" id="head_of_the_village_council_name" data-mask="" placeholder="">
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="form-group">
                                    <label>Project</label>
                                    <input type="text" class="form-control input-mask {{$errors->has('project') ? 'is-invalid':''}}" value="{{old('project',$beneficiary->project)}}" Disabled  name="project" id="project" data-mask="" placeholder="">
                                    <i class="form-group__bar"></i>
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control date-picker"  class="form-control input-mask {{$errors->has('beneficiary_date') ? 'is-invalid':''}}" Disabled value="{{old('beneficiary_date',$beneficiary->beneficiary_date)}}" name="beneficiary_date" id="beneficiary_date" placeholder="Pick a date">
                                    <i class="form-group__bar"></i>
